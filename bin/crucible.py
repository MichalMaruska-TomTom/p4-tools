...
SCRIPT_VERSION='8739693bd0c43a89ee3bc20b6a0c0e35'
...
class Configuration(object):
    ...
    def fill_from_defaults(self):
        self.url, self.username = self.url or 'https://fisheye.tomtomgroup.com', self.username or 'maruska'
        return self
...
class HgSource(PatchSource):
    ...
    def get_patch(self):
        ...
        return check_output([self.configuration.executables[self.executable()], diff_command, '--config', 'diff.git=false'])
